...
export default function Footer() {
    return (
        <footer className="relative bg-black text-white overflow-hidden border-t border-[rgba(31,34,40)]">
                    ...
                    <div className="md:min-w-45">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                { name: 'Infraestructura Cloud', href: '/servicios' },
                                { name: 'Consultoría Digital', href: '/servicios' },
                            ].map((service) => (
                                <li key={service.name}>
                                    <Link href={service.href} className="text-base text-zinc-400 hover:text-white transition-colors">
                                        {service.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div className="flex gap-3">
                        {[
                            ...
                            <a
                                key={social.name}
                                href="#"
                                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-white/20 transition-all group"
